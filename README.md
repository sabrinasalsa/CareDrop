...
├── login.php                 # Halaman login & registrasi (donatur, yayasan, admin)
├── README.md                 # Dokumentasi proyek
├── caredrop.sql              # File backup/dump database
│
├── donatur/                  # Halaman khusus donatur (session: donatur)
│   ├── dashboard.php         # Dashboard utama donatur (status donasi, riwayat, lacak resi)
│   └── sertifikat.php        # Halaman untuk melihat/unduh e-sertifikat donasi
│
├── yayasan/                  # Halaman khusus yayasan/posko (session: yayasan)
│   ├── dashboard_yayasan.php # Dashboard ringkasan yayasan
│   ├── kelola_katalog.php    # Manajemen kebutuhan barang (tambah, edit, hapus)
│   ├── tawaran_masuk.php     # Daftar tawaran donasi masuk (setujui/tolak)
│   ├── konfirmasi_terima.php # Konfirmasi penerimaan barang donasi
│   ├── lacak_pengiriman.php  # Lacak status pengiriman dari donatur
│   ├── profil_yayasan.php    # Kelola profil akun dan unggah legalitas yayasan
│   └── hapus_kebutuhan.php   # Aksi hapus data kebutuhan barang
│
├── admin/                    # Halaman khusus admin (session: admin)
│   ├── index.php             # Dashboard utama dan statistik admin
│   ├── verifikasi.php        # Verifikasi pendaftaran yayasan baru
│   ├── kelola_user.php       # Manajemen data pengguna (donatur & yayasan)
│   ├── kelola_kategori.php   # Manajemen kategori kebutuhan barang
│   ├── kelola_donasi.php     # Manajemen seluruh transaksi donasi
│   ├── kelola_sertifikat.php # Manajemen template e-sertifikat
│   ├── analitik.php          # Laporan dan analitik visual (grafik statistik)
│   ├── _sidebar.php          # Komponen sidebar untuk panel admin
│   └── aksi_*.php            # File aksi-aksi backend khusus fungsi admin
│
├── backend/                  # Kumpulan file logika backend (PHP)
│   ├── koneksi.php           # Konfigurasi koneksi database PDO
│   ├── session_config.php    # Konfigurasi session pengguna
│   ├── proses_login.php      # Logika autentikasi login (semua role)
│   ├── proses_registrasi.php # Logika pendaftaran pengguna baru
│   ├── proses_donasi.php     # Logika pemrosesan tawaran donasi
│   ├── proses_verifikasi.php # Logika verifikasi yayasan oleh admin
│   ├── lacak_resi.php        # Logika pelacakan nomor resi
│   ├── export_csv.php        # Ekspor data tabel ke format CSV
│   └── logout.php            # Logika logout dan penghapusan session
│
└── uploads/                  # Penyimpanan file yang diunggah pengguna
    ├── avatars/              # Folder penyimpanan foto profil user
    ├── donasi/               # Folder penyimpanan foto barang donasi
    ├── legalitas/            # Folder penyimpanan dokumen legalitas yayasan
    └── icon/                 # Folder penyimpanan aset visual web
```
# Tech Stack
